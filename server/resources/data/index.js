...
exports.rentals = [
  {
    ...
    star: 2.1,
    title: 'Near the swan river',
    city: 'Perth',
    street: 'Brokedale avenue',
    category: 'apartment',
    image: image1Id,
    numOfRooms: 1,
    shared: false,
    description: 'Very nice apartment in center of the city of Perth.',
    dailyPrice: 94,
    owner: user2Id,
  },
  {
  ...
  },
  {
    ...
    star: 3.8,
    title: 'Look for the view',
    city: 'Perth',
    street: 'Gracefield boulivaurd',
    category: 'apartment',
    image: image3Id,
    numOfRooms: 3,
    shared: true,
    description: 'Greate apartment in center of Perth',
    dailyPrice: 75,
    owner: user2Id,
  },
  {
    ...
    numOfRooms: 5,
    shared: false,
    description: 'Very big apartment in the main spot of perth.',
    dailyPrice: 130,
    owner: user2Id,
  },
];
